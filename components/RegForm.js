...
import React, { Component } from "react" //import react library
import { Keyboard, TouchableOpacity, Image, Text, TextInput, Button, ActivityIndicator, Alert } from "react-native"
import { View } from "native-base"
...
class RegForm extends Component {
  ...
  //   console.log("fffff: " + auth.currentUser);
  ...
  //         <TouchableOpacity
  //           onPress={() => {
  //             console.log(" check: " + this.state.currentUserState)
  //             this.state.currentUserState.sendEmailVerification();
  //             Alert.alert(
  //               "שים לב",
  //               "מייל נוסף נשלח",
  ...
  //           }}
  //         >
  //           <Text style={{ fontSize: 16, color: "#404040" }}>לא קיבלת את האימות למייל? שלח שוב...</Text>
  //         </TouchableOpacity>
  //       </View>
  //     )
  //   }
